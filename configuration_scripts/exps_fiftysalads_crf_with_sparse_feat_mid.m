...
skip_chain_length_lst = {51, 1};
window_size_lst = {51};
lambda_lasso_lst = {0.5};
dict_size_lst = {100};
use_pca_lst = {0};
nb_components_lst = {30};
...
A = allcomb(dataset_name_lst, model_name_lst, task_lst, setup_lst, ...
    ...
    gradpsi_scaling_factor, normalization, random_seed_lst, split_lst);
...
for experiment_id = experiment_ids
    ...
    params.normalization = A{experiment_id, 28};
    params.random_seed = A{experiment_id, 29};
    params.split = A{experiment_id, 30};
