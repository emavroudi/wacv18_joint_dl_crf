function param_grid_unified_jigsaws_joint_dl_crf(batch_id, nb_batches, ...
...
skip_chain_length_lst = {81};
window_size_lst = {71};
lambda_lasso_lst = {0.1};
dict_size_lst = {200};
use_pca_lst = {1};
nb_components_lst = {35};
gradpsi_scaling_factor = {1};
split_lst = {1 2 3 4 5};
random_seed_lst = {42, 2017, 123456};
...
fprintf('Nb experiments: %d', nb_experiments);
...
for experiment_id = experiment_ids
    ...
    %dbstop at 210 in train_dict_crf_scaled.m
    %dbstop at 220 in train_dict_crf_scaled.m
    %dbstop at 243 in train_dict_crf_scaled.m
    %dbstop at 43 in compute_psi_gradient_eff.m
