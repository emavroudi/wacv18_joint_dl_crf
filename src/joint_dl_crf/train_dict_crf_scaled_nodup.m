function [w, psi, optimization_log] = train_dict_crf_scaled_nodup( ...
...
for epoch = 1 : nb_epochs
    ...
    for batch = 1 : nb_training_samples
        ...
        x_sequence = histogram_sparse_codes_nodup(Uhat, window_size);
        ...
        parfor t_par = (half_win + 1) : (nb_timesteps + half_win)
            [gradPsi_temp, diff_feature_norm, gradPsi_temp_norm] = ...
                compute_psi_gradient_nodup(t_par, ...
    ...
    fprintf(['Epoch %d, unreg_loss: %f, loss: %f, acc: %f, gradw_norm: %f,', ...
        ...
        'diff_feature_norm: %f, gradPsi_temp_norm: %f, psi_diff_norm: %.10f\n'], ...
